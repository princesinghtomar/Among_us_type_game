...
int main()
{
   ...
   //    0.5f, 0.5f,  1.0f, 1.0f,0.0f,       // 4
   //    -0.5f, 0.5f,  0.0f, 1.0f,0.0f,      // 5
   //    0.5f, -0.5f,  1.0f, 0.0f,0.0f,      // 6
   //    -0.5f, -0.5f,  0.0f, 0.0f,0.0f,     // 7
   // };
   float vertices[] = {
      350.0f, 350.0f, 1.0f, 1.0f,0.0f,        // 0
      -350.0f, 350.0f, 0.0f, 1.0f,0.0f,       // 1
      350.0f, -350.0f, 1.0f, 0.0f,0.0f,       // 2
      -350.0f, -350.0f, 0.0f, 0.0f,0.0f,      // 3
      350.0f, 350.0f, 1.0f, 1.0f,0.0f,       // 4
      -350.0f, 350.0f, 0.0f, 1.0f,0.0f,      // 5
      350.0f, -350.0f, 1.0f, 0.0f,0.0f,      // 6
      -350.0f, -350.0f, 0.0f, 0.0f,0.0f,     // 7
   };
